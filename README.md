...
> **Note:** This repository handles the deep learning architecture, training, and output generation. To perform the downstream metrological and paleographical analysis (and reproduce the visualizations reported in the paper), please export the outputs from this pipeline and use our dedicated analysis toolkit: **[morphology4metrology-analysis](https://github.com/malamatenia/morphology4metrology-analysis)**.
